...
namespace FCS_StorageSolutions.Configuration
{
    ...
    internal static class Mod
    {
        ...
        internal static string GetModDirectory()
        {
            ...
            // `<pasta do DLL>/FCS_StorageSolutions`, espelhando o layout do QMods original — e cai
            // de volta na pasta do DLL se a subpasta nao existir.
            return UnhingedModPaths.ModuleFolder(Assembly.GetExecutingAssembly(), "FCS_StorageSolutions");
        }
