...
namespace FCS_EnergySolutions.Configuration
{
    ...
    internal static class Mod
    {
        ...
        internal static string GetModDirectory()
        {
            ...
            // `<pasta do DLL>/FCS_EnergySolutions`, espelhando o layout do QMods original — e cai
            // de volta na pasta do DLL se a subpasta nao existir.
            return UnhingedModPaths.ModuleFolder(Assembly.GetExecutingAssembly(), "FCS_EnergySolutions");
        }
