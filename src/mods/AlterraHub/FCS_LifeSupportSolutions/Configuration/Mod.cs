...
namespace FCS_LifeSupportSolutions.Configuration
{
    ...
    internal static class Mod
    {
        ...
        internal const string BaseOxygenTankDescription = "Provides pressurized oxygen when connected to it's own Floating Air Pump with Pipe sections. Designed for small habitats; larger habitats may require more units. Move close to see Tank utilization.";
        ...
        internal static string GetModDirectory()
        {
            ...
            // `<pasta do DLL>/FCS_LifeSupportSolutions`, espelhando o layout do QMods original — e cai
            // de volta na pasta do DLL se a subpasta nao existir.
            return UnhingedModPaths.ModuleFolder(Assembly.GetExecutingAssembly(), "FCS_LifeSupportSolutions");
        }
        #endregion
